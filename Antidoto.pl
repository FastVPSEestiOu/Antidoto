...
# TODO: Добавить проверку lsattr ом всех бинарных файликов
# TODO: пожалуй, более корректно парсить вот это дело: /proc/1045280/net/tcp
...
# TODO: извлекать локальный айпи впса для корректного парсинга нетстата
# TODO: все файлы с ppid apache (httpd) выводить как подозрительные! 
# TODO: анализировать  smaps на предмет библитек загруженных в приложение и при этом удаленных с диска
# TODO: а как хэшировать точно протрояненые либы??? 
# TODO: 
# Распространяется через puppet, в пакетах нету
# Squid в принципе может слушать по UDP: http://linuxplayer.org/2012/02/why-squid-listen-on-high-udp-port-number

# TODO: добавить проверку at spool:  at 1am tomorrow
# Они создаются в папке:  /var/spool/cron/atjobs/a000010163c1ac


# TODO: Добавить проверки, чтобы родительский процесс был не PHP 

# TODO: добавить отображение, если есть ssh сессии активные из мухосранска
